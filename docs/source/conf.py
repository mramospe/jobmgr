# -*- coding: utf-8 -*-
#
# jobmgr documentation build configuration file, created by
...
# jobmgr.core.decorate (which calls functools.wrap), only "*args, **kwargs"
...
def no_op_wraps( func ):
    ...
    Sphinx documentation. This must be done before "jobmgr" is imported.
    '''
    if func.__module__ is None or 'jobmgr' not in func.__module__:
...
import jobmgr
import os, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(jobmgr.__file__)))
...
version = jobmgr.version.__version__
# The full version, including alpha/beta/rc tags.
release = jobmgr.version.__version__
...
latex_documents = [
    (master_doc, 'jobmgr.tex', u'jobmgr Documentation',
...
man_pages = [
    (master_doc, 'jobmgr', u'jobmgr Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jobmgr', u'jobmgr Documentation',
     author, 'jobmgr', 'One line description of project.',
     'Miscellaneous'),
]
